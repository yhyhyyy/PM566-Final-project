...
###Download
You can download the PDF file by clicking [here](https://github.com/yhyhyyy/PM566-Final-project/raw/main/docs/Final_Report.pdf)
...
interactive_plot <- plot_ly(
  ...
  layout(
    title = "Figure 5:Mean Salary by Work Year and Employment Type",
