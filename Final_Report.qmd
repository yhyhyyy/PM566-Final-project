...
ggplot(salaries_data, aes(x = company_size, y = salary_in_usd, fill = company_size)) +
  geom_boxplot() +
  labs(title = "Figure4:Company Size and Salary", 
       x = "Company Size", 
       y = "Salary (USD)",
...
kable(t(salary_stats_by_company_size), caption = "Table1:Salary Statistics by Company Size (Mean, Median, SD, Min, Max, Count)")
```
